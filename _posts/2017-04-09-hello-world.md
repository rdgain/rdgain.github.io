...
<img style="float:left;width:250px;margin:10px" src="{{ site.url }}/assets/images/post1/cats.png" />
...
<img style="float:right;width:250px;margin:10px" src="{{ site.url }}/assets/images/post1/cupcakes.png" />

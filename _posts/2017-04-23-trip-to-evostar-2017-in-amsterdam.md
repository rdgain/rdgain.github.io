...
<center><img style="margin:15px;width:250px;" src="{{ site.url }}/assets/images/post3/end.png" /> <img style="margin:15px;width:250px;" src="{{ site.url }}/assets/images/post3/keynote.png" /> <img style="margin:15px;width:250px;" src="{{ site.url }}/assets/images/post3/lalaland.png" /></center>
...
<img style="margin:15px;width:250px;float:left" src="{{ site.url }}/assets/images/post3/dark.png" /> 
...
<img style="margin:15px;width:250px;float:right" src="{{ site.url }}/assets/images/post3/reddistrict.png" />
